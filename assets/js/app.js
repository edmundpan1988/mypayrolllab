...
/* Register SW only on real deployed domain, not in preview environments */
if('serviceWorker' in navigator &&
  ...
  window.addEventListener('load', function(){
    navigator.serviceWorker.register('sw.js')
      .then(function(){ console.log('MY Payroll Lab: offline ready'); })
